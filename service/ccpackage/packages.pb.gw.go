...
func request_PackageService_GetOrCreate_0(ctx context.Context, marshaler runtime.Marshaler, client PackageServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq PackageSpec
	var metadata runtime.ServerMetadata
...
func local_request_PackageService_GetOrCreate_0(ctx context.Context, marshaler runtime.Marshaler, server PackageServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq PackageSpec
	var metadata runtime.ServerMetadata
...
func RegisterPackageServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PackageServiceServer) error {
	...
	mux.Handle("POST", pattern_PackageService_Create_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
	...
	mux.Handle("PUT", pattern_PackageService_GetOrCreate_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		resp, md, err := local_request_PackageService_GetOrCreate_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_PackageService_GetOrCreate_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterPackageServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PackageServiceClient) error {
	...
	mux.Handle("PUT", pattern_PackageService_GetOrCreate_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_PackageService_GetOrCreate_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_PackageService_Create_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"ccpackages"}, "", runtime.AssumeColonVerbOpt(true)))
	...
	pattern_PackageService_GetOrCreate_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"ccpackages"}, "", runtime.AssumeColonVerbOpt(true)))
...
var (
	...
	forward_PackageService_GetOrCreate_0 = runtime.ForwardResponseMessage
