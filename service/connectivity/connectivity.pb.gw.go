...
/*
Package connectivity is a reverse proxy.
...
func request_ConnectivityService_CheckChannelConnectivity_0(ctx context.Context, marshaler runtime.Marshaler, client ConnectivityServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CheckChannelConnectivityRequest
	...
	msg, err := client.CheckChannelConnectivity(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_ConnectivityService_CheckChannelConnectivity_0(ctx context.Context, marshaler runtime.Marshaler, server ConnectivityServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CheckChannelConnectivityRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.CheckChannelConnectivity(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterConnectivityServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ConnectivityServiceServer) error {
	...
	mux.Handle("GET", pattern_ConnectivityService_CheckChannelConnectivity_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_ConnectivityService_CheckChannelConnectivity_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_ConnectivityService_CheckChannelConnectivity_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterConnectivityServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ConnectivityServiceClient) error {
	...
	mux.Handle("GET", pattern_ConnectivityService_CheckChannelConnectivity_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ConnectivityService_CheckChannelConnectivity_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_ConnectivityService_CheckChannelConnectivity_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2}, []string{"connectivity", "channel", "peers"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_ConnectivityService_CheckChannelConnectivity_0 = runtime.ForwardResponseMessage
)
