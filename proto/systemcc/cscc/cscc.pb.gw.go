...
// Note that using this registration option will cause many gRPC library features to stop working. Consider using RegisterCSCCServiceHandlerFromEndpoint instead.
...
var (
	pattern_CSCCService_JoinChain_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"systemcc", "cscc", "joinchain"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_CSCCService_GetChannels_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"systemcc", "cscc", "chains"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_CSCCService_GetConfigBlock_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"systemcc", "cscc", "chains", "channel"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_CSCCService_GetChannelConfig_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"systemcc", "cscc", "chains", "channel", "config"}, "", runtime.AssumeColonVerbOpt(true)))
)
